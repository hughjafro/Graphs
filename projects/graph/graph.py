...
class Graph:
    ...
    """Represent graph as a dictionary of vertices mapping labels to edges."""
    def __init__(self):
        self.vertices = {}
    ...
    def dft_recursive(self, starting_vertex, visited=None):
        ...
        """
        # This is in python gotchas - google search
        ...
        # Call DFT recursive on each neigbor that has not been visited
    ...
    def bfs(self, starting_vertex, destination_vertex):
        ...
        while q.size() > 0:
            ...
            if v not in visited:
                ...
                # Mark it as visited
                visited.add(v)
                # Then add A PTH TO its neighbors to the back of queue
    ...
    def dfs_recursive(self, starting_vertex, target_vertex, visited=None, path=None):
        ...
        if starting_vertex == target_vertex:
            return path
        # Otherwise, call DFS_recursive on each invisited neighbor
        for neighbor in self.get_neighbors(starting_vertex):
            if neighbor not in visited:
